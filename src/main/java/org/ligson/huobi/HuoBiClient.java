...
public class HuoBiClient {
    ...
    public HuoBiClient(String wsAddress) throws Exception {
    ...
    public void init() throws Exception {
        clientHandler = new WebSocketClientHandler(WebSocketClientHandshakerFactory.newHandshaker(uri, WebSocketVersion.V13, null, true, HttpHeaders.EMPTY_HEADERS, 100 * 1024 * 1024));
        MyChannelInitializer myChannelInitializer = new MyChannelInitializer(clientHandler);
